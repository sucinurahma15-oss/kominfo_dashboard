    ...
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-chart-bar"></i> Input Statistik Baru
            </h1>
        ...
        <div class="col-lg-8 mx-auto">
            <div class="card shadow">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0"><i class="fas fa-edit"></i> Form Input Statistik</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('statistics.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('social_media_account_id') is-invalid @enderror" 
                                ...
                                <option value="{{ $account->id }}" {{ old('social_media_account_id') == $account->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('followers') is-invalid @enderror" 
                                       id="followers" name="followers" value="{{ old('followers', 0) }}" min="0" required>
                                @error('followers')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('following') is-invalid @enderror" 
                                       id="following" name="following" value="{{ old('following', 0) }}" min="0" required>
                                @error('following')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('posts_count') is-invalid @enderror" 
                                       id="posts_count" name="posts_count" value="{{ old('posts_count', 0) }}" min="0" required>
                                @error('posts_count')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('engagement') is-invalid @enderror" 
                                       id="engagement" name="engagement" value="{{ old('engagement', 0) }}" min="0" required>
                                @error('engagement')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">Total likes + comments + shares</small>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('engagement_rate') is-invalid @enderror" 
                                   id="engagement_rate" name="engagement_rate" value="{{ old('engagement_rate', 0) }}" 
                                   min="0" max="100" required>
                            @error('engagement_rate')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">Contoh: 5.25 untuk 5.25%</small>
                        </div>

                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i>
                            <strong>Tips:</strong> Engagement Rate = (Total Engagement / Followers) × 100
                        </div>
